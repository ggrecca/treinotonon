...
function bodyFromRow(row: JsonRecord): BodyData {
  return {
    ...
    armRight: nullableText(row.arm_right_cm),
    armLeft: nullableText(row.arm_left_cm),
    forearm: row.forearm_cm === null || row.forearm_cm === undefined ? "" : cleanText(row.forearm_cm),
    forearmRight: nullableText(row.forearm_right_cm),
    forearmLeft: nullableText(row.forearm_left_cm),
    thigh: nullableText(row.thigh_cm, row.thigh),
    thighRight: nullableText(row.thigh_right_cm),
    thighLeft: nullableText(row.thigh_left_cm),
    calf: nullableText(row.calf_cm, row.calf),
    calfRight: nullableText(row.calf_right_cm),
    calfLeft: nullableText(row.calf_left_cm),
...
async function saveBodyData(body: BodyData[], replace = false): Promise<void> {
  ...
  for(const item of body) {
    ...
    const {error} = await client.from("body_records").upsert({
      ...
      arm_right_cm: numericValue(item.armRight),
      arm_left_cm: numericValue(item.armLeft),
      forearm_cm: numericValue(item.forearm),
      forearm_right_cm: numericValue(item.forearmRight),
      forearm_left_cm: numericValue(item.forearmLeft),
      thigh: numericValue(item.thigh),
      thigh_cm: numericValue(item.thigh),
      thigh_right_cm: numericValue(item.thighRight),
      thigh_left_cm: numericValue(item.thighLeft),
      calf: numericValue(item.calf),
      calf_cm: numericValue(item.calf),
      calf_right_cm: numericValue(item.calfRight),
      calf_left_cm: numericValue(item.calfLeft),
